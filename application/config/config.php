...
|
*/
$config['encryption_key'] = '9092399jifesoa02';
...
/*
 * Core Scripts
 * Connect this in controllers
 * */
$config['core_scripts'] = array(
...
$config['admin_scripts'] = array(
	'templates/brutality/js/admin.js' //Admin
);
$config['editor_scripts'] = array(
	'filemanager/js/tinymce/tinymce.min.js', /*Editor*/
	'templates/brutality/js/editor/editor.js',
);
$config['friendly_url_scripts'] = array(
	'templates/brutality/js/url/jquery.friendly_url.min.js',/*Friendly URLs*/
	'templates/brutality/js/url/url.js',
);
/*Gallery*/
$config['gallery_scripts'] = array(
	'templates/brutality/js/gallery/jquery.iframe-transport.js',
	'templates/brutality/js/gallery/jquery.ui-widget.js',
	'templates/brutality/js/gallery/jquery.fileupload.js',
	'templates/brutality/js/gallery/jquery.fileupload-process.js',
	'templates/brutality/js/gallery/gallery.js',
);
/*Cropper*/
